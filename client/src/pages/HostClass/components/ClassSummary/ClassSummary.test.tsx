...
describe('<ClassSummary /> with default props', () => {
    ...
    it('should have DetailsSection, ContactSection, SessionsSection and failure messages by default ', () => {
        const detailsValidationSpy = jest.spyOn(validationSchemas.details, 'isValidSync');
        const contactValidationSpy = jest.spyOn(validationSchemas.contact, 'isValidSync');
        const sessionsValidationSpy = jest.spyOn(validationSchemas.sessions, 'isValidSync');
...
describe('<ClassSummary /> -> <SessionsSection /> ', () => {
    const sessionsSectionTestCases: Array<{ values: ClassSession[], expected: boolean, description: string }> =
        [{
            values: [],
            expected: false,
    ...
    const navigationTestCases = [
        {
            values: invalidValues,
            expected: false,
            description: 'should have correct previous button and submit button is disabled'
        },
        {
            values: validValues,
            expected: true,
            description: 'should have correct previous button and submit button is enabled'
        }
    ];
